...
| `--harvester-sources SOURCES` | Comma-separated list of theHarvester backends (default: `bufferoverun,crtsh,dnsdumpster,hackertarget,otx,rapiddns,threatcrowd,urlscan`). | `--harvester-sources crtsh,otx,threatcrowd` |
